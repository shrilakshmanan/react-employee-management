...
// EmployeeServices.deleteEmployee(id);
  ...
  deletemployee(id){
    ...
    EmployeeServices.deleteactive(id).then(res =>{
    ...
    componentDidMount(){
      //  console.log("id"+this.state.id);
        //This is js promise here this will wait until the response is came
                EmployeeServices.ActiveProjects(this.state.ids).then((res) =>{
...
<div class="modal-content">
  ...
  <div class="modal-footer justify-content-center">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
      ...
      <td>
      <ToastContainer /> 
    {/* <button onClick={ () =>  this.deletemployee(projects.projectid)}  className="btn btn-danger">Delete</button>
    <ToastContainer /> */}
    </td>  
</tr>
