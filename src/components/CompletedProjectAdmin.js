...
import Card from 'react-bootstrap/Card';
 ...
 class CompletedProjectAdmin extends Component {
    ...
    componentDidMount(){
      ...
      //  console.log("id"+this.state.id);
        //This is js promise here this will wait until the response is came
                EmployeeServices.AllCompletedproject().then((res) =>{
                    ...
                    var myObject={} 
                    for( var i=0;i<=5;i++){
                    console.log(res.data[i].employeeid);

                 myObject= JSON.parse(res.data[i].employeeid);
        ...
        // EmployeeServices.deleteEmployee(id);
          ...
          const timer = setTimeout(() => {
            window.location.href = '/CompletedProjectAdmin';
          }, 1100);
...
export default CompletedProjectAdmin;
