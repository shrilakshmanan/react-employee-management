...
import { FaTelegramPlane,FaUserTie } from "react-icons/fa";
...
class Sidenavbar_Employee extends Component {
  compare=(event)=>{
  ...
  render() {
    return (
      ...
      // <div >
      //   <div class="row" >
      <div class="px-0" style={{ backgroundColor: "white",height:"100%"}}>
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white min-vh-100">
<i alt="hugenerd" width="10" height="30" class="rounded-circle" ><FaUserTie  style={{color:'white',width:"81",height:60}}/></i>
    <span>
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item m-1">
              <a href="/AfterLogin" class="nav-link align-middle px-0">
                ...
                <span class="ms-1 d-none d-sm-inline" style={{ color: "white", "font-size": "19px" }}> Home</span>
              </a>
              <hr style={{ backgroundColor: "white",height: 5,width: 350,}}/>
            </li>
            <li>
              <a href="/ListEmpLeaves" data-bs-toggle="collapse"  class="nav-link px-0 align-middle m-1">
                ...
                <span class="ms-1 d-none d-sm-inline" style={{ color: "white", "font-size": "19px" }}>  Leave</span>{" "}
              </a>
              <hr
                style={{ backgroundColor: "white",height: 5, width: 350, }}
              />
            </li>
            <li>
              <a
                href="/ProjectEmpDisplay"
                class="nav-link px-0 align-middle m-1"
              >
                <i
...
export default Sidenavbar_Employee;
